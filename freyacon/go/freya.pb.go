...
type SendEmailParams struct {
	...
	TemplateName         string            `protobuf:"bytes,3,opt,name=templateName,proto3" json:"templateName,omitempty"`
	Params               map[string]string `protobuf:"bytes,4,rep,name=params,proto3" json:"params,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Attachment           map[string]string `protobuf:"bytes,5,rep,name=attachment,proto3" json:"attachment,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *SendEmailParams) GetAttachment() map[string]string {
	if m != nil {
		return m.Attachment
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "freya.SendEmailParams.AttachmentEntry")
...
var fileDescriptor_c1a59bcae510a086 = []byte{
	...
	,
}
